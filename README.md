...
4. Live Z- and X- data should appear given as an unsigned integer between 0 and 240 (inclusive) ![Gesture Arduino Run](https://cdn.sparkfun.com/assets/learn_tutorials/3/4/5/ZX_Demo_run.png)
